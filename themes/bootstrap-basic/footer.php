	...
	<div class="container">
		...
		<div class="first-row">
			...
			<div class="socials-content">
				...
				<!-- <div class="social-icon">
					<a href="facebook.com" target="_blank">
						<svg xmlns="http://www.w3.org/2000/svg" width="19.719" height="20.228">
							<path d="M19.19 14.822c-2.488-.447-3.625-3.256-3.662-3.347l-.023-.062a.805.805 0 0 1-.087-.56c.109-.281.626-.46.936-.568.109-.038.213-.073.293-.108.752-.325 1.127-.748 1.118-1.263a1.08 1.08 0 0 0-.727-.958 1.174 1.174 0 0 0-.492-.1 1.053 1.053 0 0 0-.465.1 1.932 1.932 0 0 1-.717.234.72.72 0 0 1-.1-.011l.018-.321a11.564 11.564 0 0 0-.261-4.364 5.311 5.311 0 0 0-4.978-3.495h-.378a5.3 5.3 0 0 0-4.967 3.497 11.527 11.527 0 0 0-.261 4.364v.055l.015.265a1.681 1.681 0 0 1-.926-.223 1.175 1.175 0 0 0-1.562.814c-.057.323.012.936 1.1 1.405.082.036.184.071.295.11.308.108.825.285.934.568a.863.863 0 0 1-.1.595c-.047.119-1.177 2.927-3.67 3.374a.675.675 0 0 0-.525.717.909.909 0 0 0 .062.277c.226.579 1.048.976 2.582 1.248.027.1.057.245.074.325.032.166.067.334.114.509a.693.693 0 0 0 .686.551 2.427 2.427 0 0 0 .482-.071 4.4 4.4 0 0 1 .981-.122 4 4 0 0 1 .7.064 3.265 3.265 0 0 1 1.286.734 4.331 4.331 0 0 0 2.776 1.173H9.98a4.349 4.349 0 0 0 2.778-1.173 3.281 3.281 0 0 1 1.284-.734 4 4 0 0 1 .7-.064 4.441 4.441 0 0 1 .983.115 2.4 2.4 0 0 0 .5.062.673.673 0 0 0 .665-.542c.047-.172.08-.338.114-.506.013-.062.045-.219.074-.323 1.534-.272 2.356-.67 2.58-1.243a.921.921 0 0 0 .064-.285.677.677 0 0 0-.532-.713Z" fill="#fff" />
						</svg>
					</a>
				</div> -->
