...
const proxy = (app) => {
    ...
    return (0, http_proxy_middleware_1.createProxyMiddleware)(app.hooks.filter(`middleware.proxy.options`, {
        /**
         * Change origin
         */
         ...
         */
        cookieDomainRewrite: app.hooks.filter(`middleware.proxy.options.cookieDomainRewrite`, {
         ...
         */
        onProxyRes: app.hooks.filter(`middleware.proxy.options.onProxyRes`, interceptor.make),
        /**
         * Protocol rewrite
         */
