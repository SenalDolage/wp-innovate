...
export declare namespace Hooks {
     ...
     * @public
     */
    type Hook<T extends keyof Map & string> = ((value?: T) => Map[T]) | ((value?: T) => Partial<Map[T]>) | Map[T] | Partial<Map[T]>;
    /**
     ...
     * @public
     */
    interface Map extends Server.Middleware.Middleware<`options`>, Server.Middleware.Middleware<`factory`> {
        [`build.bail`]: boolean;
        [`build.cache`]: any;
