...
const dynamic = __importStar(require("../config/dynamic.config.js"));
const manifest = __importStar(require("../config/manifest.config.js"));
const index_js_1 = require("../Notifier/index.js");
/**
 * Base command
 *
 * @public
...
class BaseCommand extends clipanion_1.Command {
     ...
     */
    async make() {
        this.notifier = new index_js_1.Notifier(this.app);
        try {
